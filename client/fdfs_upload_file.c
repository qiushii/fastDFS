...
int main(int argc, char *argv[])
{
	...
	*group_name = '\0';
	...
	else if ((result=tracker_query_storage_store(pTrackerServer, \		// tracker_query_storage_store宏定义，本质tracker_query_storage_store_without_group 
	                &storageServer, group_name, &store_path_index)) != 0)			// 请求
	{
		fdfs_client_destroy();
	...
	result = storage_upload_by_filename1(pTrackerServer, \				// 上传文件
